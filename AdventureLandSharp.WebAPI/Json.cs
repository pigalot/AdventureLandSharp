...
public class NamedSystemTextJsonInputFormatter(
    ...
    public override bool CanRead(InputFormatterContext context) => context.HttpContext.GetJsonSettingsName() == SettingsName && base.CanRead(context);
}
...
public static class JsonExtensions {
    ...
    public static string? GetJsonSettingsName(this HttpContext context) => context.GetEndpoint()?.Metadata.GetMetadata<JsonSettingsNameAttribute>()?.Name;
}
